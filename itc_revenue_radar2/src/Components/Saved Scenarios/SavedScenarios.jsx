            ...
            <div className="ss-section-card">
              <div className="row g-3">
                <div className="col-12 col-md-6 col-lg-3">
                  ...
                  <select
                    className="form-select ss-native-select"
                    value={selectedyear}
                    onChange={(e) => {
                ...
                <div className="col-12 col-md-6 col-lg-3">
                  ...
                  <select
                    value={maskedBrandOption.maskedBrandOption[selectedbrand]}
                    className="form-select ss-native-select"
                    onChange={(e) => {
                      setselectedbrand(
                        unMaskedBrandOption.unMaskedBrandOption[e.target.value]
                      );
                      setmarket("Select");
                      setselectedscenarioname("");
                      setviewscenariodatatable(false);
                ...
                <div className="col-12 col-md-6 col-lg-3">
                  ...
                  >
                    ...
                    {marketoptions?.map((item) => (
                      <option key={item.final_market}>{item.final_market}</option>
                    ))}
                  </select>
                </div>
