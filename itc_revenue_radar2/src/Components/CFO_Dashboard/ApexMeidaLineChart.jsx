    ...
    () => ({
      ...
      dataLabels: {
        ...
        background: {
          ...
          foreColor: isDark ? "#2C3E50" : "#E5E7EB",
          borderWidth: 1,
          borderColor: isDark ? "#4A6274" : "#E5E7EB",
          color: isDark
            ? "rgba(44, 62, 80, 0.31)"   // dark glass
