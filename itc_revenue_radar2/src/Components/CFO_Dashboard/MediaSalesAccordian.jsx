...
const MediaSalesAccordian = ({ data, till, compare }) => {
    ...
    const yearly_sales_media_grp_wise = data?.yearly_sales_media_grp_wise
    const totals = yearly_sales_media_grp_wise.reduce((acc, item) => {
    ...
    }, [yearly_sales_media_grp_wise]);

    const tableData =
        viewType === "quarterly"
            ? null
            : yearly_sales_media_grp_wise.map((it) => ({
                quarter: "FY Total",
    ...
    const pieData = yearly_sales_media_grp_wise.map((row) => ({
        name: row.media_group,
        value: Number((row.current_fy / 10000000).toFixed(3)), // convert to crores
    }));
                ...
                <>
                                    ...
                                    <div className="modal-content border-0 shadow">
                                        ...
                                        <div className="modal-header bg-light">
                                            <h5 className="modal-title fw-semibold">
                                                {medidGroupType} - Media Sales Details
                                            </h5>
                                            <button
                                                type="button"
                                                className="btn-close"
                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-sm align-middle">
                                                    ...
                                                    <tbody>
                                                        {(() => {
                                                            const filteredData =
                                                                data?.yearly_sales_media_var_wise?.filter(
                                                                    (row) =>
                    ...
                    <div className="mt-3 px-2 bg-white">
                        ...
                        <CampaignSalesChart
                            ...
                            campaignData={data?.qtr_sales_media_var_wise} // same as you had in your table
...
export default MediaSalesAccordian