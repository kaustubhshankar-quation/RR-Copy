  ...
  return (
    <div className="container-fluid py-3">
          ...
          <div className="card border-0 shadow-sm h-100 region-kpi-card">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start">
                ...
                <div className="icon-wrap" style={{ background: isDark ? "rgba(44,62,80,0.15)" : "#F0F4F8", color: isDark ? "#F8F9FA" : "#2C3E50" }}>
      ...
      <style>{`
        ...
        .region-performance-card .text-warning,
        .quarter-region-card .text-warning {
