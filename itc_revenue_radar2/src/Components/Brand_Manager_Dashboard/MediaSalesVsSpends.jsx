...
const MediaSalesVsSpends = () => {
  const { spendsData, mediaSalesData, loading } = useSelector((state) => state.dashboard || {});
  ...
  .media-compare-dashboard {
    ...
    --chip-success-text: ${isDark ? "#FFC107" : "#0D7C66"};
    --section-bg: ${isDark ? "rgba(13, 124, 102, 0.15)" : "#E8F5E8"};
    --section-text: ${isDark ? "#FFC107" : "#0D7C66"};
  ...
  .media-compare-dashboard .premium-header-card h3 {
  ...
  .media-compare-dashboard .view-toggle-btn:hover {
    ...
    border-color: ${isDark ? "rgba(13, 124, 102, 0.45)" : "rgba(13, 124, 102, 0.28)"};
    box-shadow:
      0 8px 18px rgba(0, 0, 0, 0.14),
      0 0 0 3px ${isDark ? "rgba(13, 124, 102, 0.10)" : "rgba(13, 124, 102, 0.08)"};
  }
  ...
  .media-compare-dashboard .view-toggle-btn:focus-visible {
    outline: none;
    box-shadow:
      0 0 0 3px ${isDark ? "rgba(13, 124, 102, 0.18)" : "rgba(13, 124, 102, 0.14)"},
  ...
  .media-compare-dashboard .kpi-value.text-primary {
    color: ${isDark ? "#F8F9FA" : "#2C3E50"} !important;
  }

  .media-compare-dashboard .kpi-value.text-success {
    color: ${isDark ? "#FFC107" : "#198754"} !important;
  }

  .media-compare-dashboard .kpi-value.text-danger {
      ...
      <div className="premium-header-card mb-4">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
          <div className="d-flex flex-column">
            <div className="section-label mb-2">Media Analysis</div>
