  ...
  return (
    <>
      ...
      <style>{`
        ...
        .dark-theme .sr-report-badge {
          background: rgba(23, 162, 184, 0.12);
          border-color: rgba(23, 162, 184, 0.22);
          color: #17A2B8;
        }

        .dark-theme .sr-type-chip {
          background: rgba(23, 162, 184, 0.10);
          border-color: rgba(23, 162, 184, 0.22);
        }

        .dark-theme .sr-report-card:hover {
          border-color: rgba(23, 162, 184, 0.28);
        }

        .dark-theme .sr-native-select:focus {
          border-color: #17A2B8;
          box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.16) !important;
        }

        .dark-theme .sr-select__control:hover {
          border-color: rgba(23, 162, 184, 0.40) !important;
        }

        .dark-theme .sr-select__control--is-focused {
          border-color: #17A2B8 !important;
          box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.16) !important;
        }

        .dark-theme .sr-select__option--is-focused {
          background: rgba(23, 162, 184, 0.08) !important;
        }

        .dark-theme .sr-select__option--is-selected {
          background: rgba(23, 162, 184, 0.15) !important;
          color: #17A2B8 !important;
        }

        .dark-theme .sr-select__option:active {
          background: rgba(23, 162, 184, 0.16) !important;
        }

        .dark-theme .sr-pagination-btn:hover,
        .dark-theme .sr-page-number:hover {
          border-color: rgba(23, 162, 184, 0.35);
        }

        .dark-theme .sr-page-number.active {
          background: linear-gradient(135deg, #17A2B8 0%, #138496 100%);
          box-shadow: 0 4px 12px rgba(23, 162, 184, 0.20);
        }

        .dark-theme .sr-empty-message-soft {
