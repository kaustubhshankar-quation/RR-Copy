...
import CFOdashboard from '../CFO_Dashboard/dashboard';
import IndexPage from '../Brand_Manager_Dashboard/indexPage';
...
function Dashboard() {
    ...
    const renderCard = (title, subtitle, description, index, attaLink, otherLink, onClick, isAdminOnly = false, isBrandManager = false) => {
        ...
        return (
            ...
            >
                <div className="afterlogcon3box1 h-100 dashboard-card-shell">
                    ...
                    <div className="col-12 dashboard-card-body">
                        <p>{description}</p>
        ...
        <>
            <>
                ...
                <div className="dashboard-home-page">
                    <div className="dashboard-home-hero">
                        <div className="hero-inner">
                            <div className="hero-left">
                                <div className="hero-tag">Decision Intelligence Suite</div>
                                <h1 className="hero-title">Executive Control Center</h1>
                                <p className="hero-subtitle">
                                    Access diagnostics, simulation, optimization, reporting and brand-level
                                    intelligence from one unified dashboard.
                                </p>
                            </div>
                    ...
                    <div className="container-fluid aftrlogincontainer3 dashboard-home-container">
                        <div className="container-fluid row d-flex align-items-stretch">
            ...
            <style>{`
                ...
                .hero-inner {
                    ...
                    padding: 28px 30px;
                    border-radius: 24px;
                    background: linear-gradient(135deg, #ffffff 0%, #f8fbff 58%, #f0fdf4 100%);
                ...
                .dashboard-card-btn iconify-icon {
                    font-size: 16px;
                }
