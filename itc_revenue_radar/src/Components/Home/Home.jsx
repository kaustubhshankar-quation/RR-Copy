  ...
  return (
    <>
      ...
      .rr-user-trigger {
        min-height: 54px;
        border: 1px solid var(--border-soft);
        background: var(--user-trigger-bg);
        color: var(--text-main);
        border-radius: 999px;
        padding: 0 18px;
        display: inline-flex;
        ...
        gap: 18px;
        min-width: 270px;
        box-shadow: var(--user-trigger-shadow);
        backdrop-filter: blur(16px);
        -webkit-backdrop-filter: blur(16px);
        transition: all 0.25s ease;
      }

      .rr-user-trigger:hover {
        transform: translateY(-1px);
        box-shadow: var(--user-trigger-shadow-hover);
        border-color: var(--user-trigger-border-hover);
      }

      .rr-user-trigger:focus,
      .rr-user-trigger:active {
        outline: none;
        box-shadow: var(--user-trigger-shadow-hover);
        border-color: var(--user-trigger-border-hover);
      }

      .rr-user-trigger-left {
        display: inline-flex;
        align-items: center;
        gap: 12px;
        min-width: 0;
      ...
      .rr-user-caret {
        ...
        .rr-user-menu-item-danger {
          color: #ef4444;
        }

        .rr-user-menu-item-danger .rr-user-menu-icon {
