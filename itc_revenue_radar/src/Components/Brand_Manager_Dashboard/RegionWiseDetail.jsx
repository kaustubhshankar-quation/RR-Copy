...
const RegionWiseDetail = () => {
  ...
  const styles = `
    ...
    .region-dashboard .section-label {
      ...
      padding: 6px 12px;
      border-radius: 999px;
      background: ${isDark ? "rgba(13,124,102,0.15)" : "rgba(13,124,102,0.08)"};
    ...
    .region-dashboard .header-icon {
      ...
      background: linear-gradient(
        135deg,
        ${isDark ? "rgba(13,124,102,0.2)" : "rgba(13,124,102,0.08)"} 0%,
        ${isDark ? "rgba(23,162,184,0.15)" : "rgba(23,162,184,0.06)"} 100%
      );
      color: ${isDark ? "#17A2B8" : "#0D7C66"};
      font-size: 1rem;
    }
    ...
    .region-dashboard .quarter-switch-btn.active {
      background: #0D7C66;
      color: #ffffff;
      box-shadow: 0 6px 16px rgba(13, 124, 102, 0.25);
    }
    ...
    .region-dashboard .text-success {
      color: ${isDark ? "#17A2B8" : "#0D7C66"} !important;
    }

    .region-dashboard .text-danger {
