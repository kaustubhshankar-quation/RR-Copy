    ...
    <>
      ...
      <style>{`
        ...
        .modern-sidebar.light {
          ...
          border-right: 1px solid rgba(23, 162, 184, 0.12);
          color: #F8F9FA;
        ...
        .sidebar-user-card:hover {
          background: rgba(23, 162, 184, 0.32);
        ...
        /* Active — Sophisticated Teal #17A2B8 accent */
        .sidebar-nav-link.active {
          background: linear-gradient(135deg, rgba(23, 162, 184, 0.40) 0%, rgba(23, 162, 184, 0.28) 100%);
          color: #FFFFFF;
