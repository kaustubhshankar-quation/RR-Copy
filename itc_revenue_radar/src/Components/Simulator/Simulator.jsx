 ...
 `,
  ...
  return (
    <>
                  ...
                  <div className="container-fluid px-0">
                    <div id="simulateddata">
                      <div className="d-flex my-2 justify-content-between align-items-center flex-wrap gap-2">
                        <h5 className="mb-0" style={{ fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 700, fontSize: '16px', letterSpacing: '0.01em' }}>Simulated Results</h5>
                        <button
                          className="sim-primary-btn"
                    ...
                    {scenarionewoldscreen === "new" && (
                      <>
                        <div className="d-flex flex-wrap gap-3 my-3">
                          {["Y", "HY", "Q", "M"].map((type) => {
                            const disableType = ['HY','Q','M']
                            let disableFlag = UserService.hasRole(['SALES']) ? disableType.includes(type) : false
                            return (
      ...
      #attributetable.sim-section-card {
        border: none;
      ...
      body.dark-theme .sim-select__menu {
      ...
      body.dark-theme .sim-select__menu-list {
        background: #2C3E50 !important;
      }
      ...
      body.dark-theme .sim-select__option {
        background: #2C3E50 !important;
      ...
      body.dark-theme .sim-select__option--is-focused {
      ...
      body.dark-theme .sim-select__option--is-selected {
        background: rgba(23, 162, 184, 0.15) !important;
        color: #17A2B8 !important;
      }

      .sim-select__option:active {
        background: rgba(13, 124, 102, 0.14) !important;
        color: var(--rr-text-main, #2C3E50) !important;
      }

      body.dark-theme .sim-select__option:active {
        background: rgba(23, 162, 184, 0.18) !important;
        color: #F8F9FA !important;
      }

      .sim-select__indicator-separator {
        background-color: var(--rr-border, #E5E7EB) !important;
      }

      body.dark-theme .sim-select__indicator-separator {
      ...
      body.dark-theme .sim-select__dropdown-indicator,
      body.dark-theme .sim-select__clear-indicator {
        color: #ADB5BD !important;
      }

      .sim-select__dropdown-indicator:hover,
      .sim-select__clear-indicator:hover {
        color: var(--rr-text-main, #F8F9FA) !important;
      }

      .sim-select__menu-notice,
      .sim-select__no-options-message,
      .sim-select__loading-message {
        color: var(--rr-text-muted, #ADB5BD) !important;
        background: var(--rr-bg-soft, #2C3E50) !important;
      }
      ...
      .dark-theme .sim-select__placeholder,
      .dark-theme .sim-select__single-value,
      .dark-theme .sim-select__input-container {
        color: var(--rr-text-main) !important;
      }

      .dark-theme .sim-select__control:hover {
        border-color: rgba(23, 162, 184, 0.40) !important;
      }

      .dark-theme .sim-select__control--is-focused {
        border-color: #17A2B8 !important;
        box-shadow: 0 0 0 2px rgba(23, 162, 184, 0.15) !important;
      }

      .dark-theme .sim-select__multi-value {
        background: rgba(23, 162, 184, 0.10) !important;
      }

      .dark-theme .sim-select__multi-value__label {
        color: #17A2B8 !important;
      }
