  ...
  const customMultiSelectStyles = {
    ...
    option: (base, state) => ({
      ...
      background: state.isSelected
        ? isDark ? "linear-gradient(135deg, #17A2B8 0%, #138496 100%)" : "linear-gradient(135deg, #0D7C66 0%, #0A6B57 100%)"
        : state.isFocused
          ? isDark ? "rgba(23, 162, 184, 0.12)" : "rgba(13, 124, 102, 0.12)"
          : "transparent",
      color: state.isSelected ? "#ffffff" : isDark ? "#F8F9FA" : "#0f172a",
    }),
    multiValue: (base) => ({
      ...base,
      background: isDark ? "rgba(23, 162, 184, 0.12)" : "rgba(13, 124, 102, 0.12)",
      borderRadius: "10px",
    }),
  ...
  return (
    <>
            ...
            <div className="opt-header-actions">
              ...
              {loading ? (
                ...
                <button
                  ...
                  //   }
                  // }}
                  onClick={() => { toast.warning('The Feature will be live from 20 April,2026.') }}
                >
                  Generate Report
                </button>
              )}
                ...
                <div className="row g-3 align-items-center my-1">
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    <div className="opt-meta-card">
                      ...
                      <div className="opt-meta-value">{displaynames.scenario}</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      .opt-completion-time-badge {
        ...
        padding: 6px 14px;
        border-radius: 999px;
        background: linear-gradient(135deg, rgba(13, 124, 102, 0.15) 0%, rgba(10, 107, 87, 0.12) 100%);
      ...
      .opt-select__option--is-selected {
        background: linear-gradient(135deg, #0A6B57 0%, #0D7C66 100%) !important;
        color: #ffffff !important;
        font-weight: 600 !important;
      }

      .opt-select__option:active {
        background: rgba(13, 124, 102, 0.16) !important;
        color: var(--rr-text-main) !important;
      }
      ...
      .opt-select__multi-value {
        background: rgba(13, 124, 102, 0.12) !important;
        border-radius: 8px !important;
      }
      ...
      .dark-theme .opt-completion-time-badge,
      body.dark-theme .opt-completion-time-badge {
        background: linear-gradient(135deg, rgba(23, 162, 184, 0.15) 0%, rgba(19, 132, 150, 0.12) 100%);
        border-color: rgba(23, 162, 184, 0.25);
        color: #17A2B8;
      }

      .dark-theme .opt-input:focus,
      body.dark-theme .opt-input:focus {
        border-color: #17A2B8 !important;
        box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.16) !important;
      }

      .dark-theme .opt-select__control:hover,
      body.dark-theme .opt-select__control:hover {
        border-color: rgba(23, 162, 184, 0.40) !important;
      }

      .dark-theme .opt-select__control--is-focused,
      body.dark-theme .opt-select__control--is-focused {
        border-color: #17A2B8 !important;
        box-shadow: 0 0 0 3px rgba(23, 162, 184, 0.16) !important;
      }

      .dark-theme .opt-select__option--is-focused,
      body.dark-theme .opt-select__option--is-focused {
        background: rgba(23, 162, 184, 0.08) !important;
      }

      .dark-theme .opt-select__option--is-selected,
      body.dark-theme .opt-select__option--is-selected {
        background: linear-gradient(135deg, #138496 0%, #17A2B8 100%) !important;
      }

      .dark-theme .opt-select__option:active,
      body.dark-theme .opt-select__option:active {
        background: rgba(23, 162, 184, 0.16) !important;
      }
    `}</style>
    </>
  );
